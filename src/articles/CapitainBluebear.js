...
export const capitainBluebearImage = "https://vignette.wikia.nocookie.net/zamonien/images/2/2a/Blaub%C3%A4r_in_der_Walnussschale.png/revision/latest?cb=20160124161219&path-prefix=de";

export const CapitainBluebear = () => {
    return (
        <Article title="The 13 1/2 Lives of Capitain Bluebear" image={capitainBluebearImage}>
